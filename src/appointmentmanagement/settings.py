...
DATABASES = {
    "default": {
        ...
        "USER":     os.environ["POSTGRES_USER"],
        "PASSWORD": os.environ["POSTGRES_PASSWORD"],
        "HOST":     os.environ["DB_HOST"],  # should be pgbouncer_appointment
...
CELERY_BROKER_URL = "redis://redis_appointment:6379/0"
CELERY_RESULT_BACKEND = "redis://redis_appointment:6379/1"
...
CACHES = {
    "default": {
        ...
        "LOCATION": (
            f"redis://{os.getenv('REDIS_CACHE_HOST','redis_cache_appointment')}:"
